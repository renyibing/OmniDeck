...
import { LAYOUTS, type DeviceGroup, type LayoutSize } from '../domain';

interface Props {
  groups: DeviceGroup[]; groupId: string; layout: LayoutSize; selectedCount: number; workspaceName: string;
  onGroup: (id: string) => void; onLayout: (layout: LayoutSize) => void; onSelectAll: () => void; onWallOnly: () => void; onName: (value: string) => void; onSave: () => void; onCreateGroup: () => void;
}
